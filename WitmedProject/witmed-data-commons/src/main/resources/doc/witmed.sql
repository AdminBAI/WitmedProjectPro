...
-- ----------------------------
-- Table structure for sys_patient_addr
-- ----------------------------
DROP TABLE IF EXISTS `sys_patient_addr`;
CREATE TABLE `sys_patient_addr`  (
`id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Records of sys_patient_addr
-- ----------------------------

-- ----------------------------
-- Table structure for sys_patient_comm
-- ----------------------------
DROP TABLE IF EXISTS `sys_patient_comm`;
CREATE TABLE `sys_patient_comm`  (
`id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Records of sys_patient_comm
-- ----------------------------

-- ----------------------------
-- Table structure for sys_patient_contact
-- ----------------------------
DROP TABLE IF EXISTS `sys_patient_contact`;
CREATE TABLE `sys_patient_contact`  (
`id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主键',
`patient` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '病人信息',
...
-- ----------------------------
-- Records of sys_patient_contact
-- ----------------------------

-- ----------------------------
-- Table structure for sys_patient_dxtrt
-- ----------------------------
DROP TABLE IF EXISTS `sys_patient_dxtrt`;
CREATE TABLE `sys_patient_dxtrt`  (
`id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主键',
`patient` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '病人信息',
`emrNo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '病历号',
...
-- ----------------------------
-- Records of sys_patient_dxtrt
-- ----------------------------

-- ----------------------------
-- Table structure for sys_patient_ins
-- ----------------------------
DROP TABLE IF EXISTS `sys_patient_ins`;
CREATE TABLE `sys_patient_ins`  (
`id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主键',
`patient` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '病人信息',
`insCat` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '医疗保险-类别',
...
-- ----------------------------
-- Records of sys_patient_ins
-- ----------------------------

-- ----------------------------
-- Table structure for sys_patient_occ
-- ----------------------------
DROP TABLE IF EXISTS `sys_patient_occ`;
CREATE TABLE `sys_patient_occ`  (
`id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主键',
`patient` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '病人信息',
