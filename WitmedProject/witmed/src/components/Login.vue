  ...
  <div class="login_container">
    <div class="login_box">
      ...
      <el-form size="mini">
        <!-- 用户名 -->
        <el-form-item>
          <el-input placeholder="请输入手机号码" prefix-icon="el-icon-phone" v-model="cellphone"></el-input>
        </el-form-item>
        <!-- 密码 -->
        <el-form-item>
          <el-input placeholder="请输入密码" prefix-icon="el-icon-lock" v-model="password"></el-input>
        </el-form-item>
        <!-- 记住我 -->
        <el-form-item>
